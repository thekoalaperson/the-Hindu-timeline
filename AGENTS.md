...
mythology, cosmology, scripture, and tradition (~530 markdown files, ~1.19M words). This file tells an
...
4. For **"what happened and when"**, use **[`TIMELINE.md`](TIMELINE.md)** — all 5,198 events sorted on the cosmic clock (Creation → Manvantaras → Satya → Tretā → Dvāpara → Kali → Future), each linked to its detail file.
