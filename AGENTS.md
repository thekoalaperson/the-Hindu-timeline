...
mythology, cosmology, scripture, and tradition (~350 markdown files, ~835k words). This file tells an
...
4. For **"what happened and when"**, use **[`TIMELINE.md`](TIMELINE.md)** — all 3,493 events sorted on the cosmic clock (Creation → Manvantaras → Satya → Tretā → Dvāpara → Kali → Future), each linked to its detail file.
