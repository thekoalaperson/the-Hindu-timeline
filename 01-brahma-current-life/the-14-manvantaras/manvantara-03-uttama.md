...
### The Manu's Sons (sharp source-split)

- *Variant (Bhagavata Purana 5.1.28; 8.1):* the sons are **Pavana, Srinjaya and Yajnahotra** ("Pavana and others").
- *Variant (Vishnu Purana 3.1, Wilson tr.):* the sons are **Aja, Parashu, Divya and others**.
- *Variant (Matsya Purana / Vayu-type lists):* a ten-son enumeration is given — **Isha, Urja, Tanurja, Madhu, Madhava, Suchi, Shukra, Saha, Nabharya and Nabha** [late text / parallel list; note these names overlap the lunar-month names].

[The three lists do not reconcile; catalog all. No story attaches to any of these sons in the surviving texts.]

## The Indra (two main streams)

- **Indra = Satyajit** — during Uttama's reign Satyajit holds the office of Indra, king of the devas (Bhagavata Purana 8.1.23–24). This is the stream that ties the avatar Satyasena to a named Indra he fights beside.
- *Variant (Vishnu Purana 3.1; Brahmanda Purana II.36; Brahma/Vayu-type lists):* the Indra of this manvantara is **Sushanti** (Suśānti), not Satyajit. The vyasaonline encyclopedia and Vishnu Purana both carry Sushanti.

[Catalog both — the two main streams (Bhagavata = Satyajit; Vishnu/Brahmanda = Sushanti) genuinely disagree. This is the most-cited divergence for the third manvantara.]

## The Deva Classes (each tradition lists a different set)

- *Variant (Bhagavata Purana / vyasaonline):* the orders of gods are the **Satyas, Devashrutas (Vedashrutas) and Bhadras**.
- *Variant (Vishnu Purana 3.1, Wilson tr.):* **five orders, each of twelve divinities** — the **Sudhamas, Satyas, Shivas, Pradarshanas (Pratardanas) and Vasavartis (Vasavertis)**.
- *Variant (Matsya/Vayu-type lists):* the celestials of this period are called the **Bhanus**.
- *Variant (Saurapurana, ~10th c.):* the **Sudhamas** are reckoned as twelve groups, "like **Pratardana, Shiva, Satya, Vashavarti**" [late text].

[No two streams agree; the recurring threads are "Satyas," a "Shiva/Sudhama" group, and a "Pratardana/Pradarshana" group. Catalog all.]
...
## Sources
- Bhagavata Purana (Srimad Bhagavatam), Canto 5 Ch. 1 (parentage) and Canto 8 Ch. 1 (the manvantara roll-call; Satyajit as Indra; Satyasena avatar; Kaukundihi-headed-by-Pramada saptarishis).
- Vishnu Purana, Book III, Ch. 1 (Wilson translation) — "An Account of the several Manus and Manvantaras" (Sushanti as Indra; five deva-orders; Aja/Parashu/Divya sons; sons of Vasishtha reborn from Urja).
- Brahmanda Purana II.36 — variant naming Sushanti as Indra.
- Matsya Purana — parallel lists (Havindhra/Sukriti/Murtti… seven Prajapatis; Bhanu devas; ten-son enumeration), as cited in Wilson's notes.
- Saurapurana (~10th c.) — Sudhamas / Pratardana-Shiva-Satya deva groups [late text].
- [Vishnu Purana, Book III Ch. I (Wisdomlib)](https://www.wisdomlib.org/hinduism/book/vishnu-purana-wilson/d/doc115978.html)
- [The Vishnu Purana, Book III Ch. I (Sacred-Texts)](https://sacred-texts.com/hin/vp/vp075.htm)
- [Manvantara — Vyasa Mahabharata (vyasaonline)](https://www.vyasaonline.com/encyclopedia/manvantara/)
- [Uttama, Uttamā — 42 definitions (Wisdomlib)](https://www.wisdomlib.org/definition/uttama)
