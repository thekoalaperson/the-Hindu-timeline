...
## The Origin Legend — Svarocis and the Birth of Svārociṣa (Mārkaṇḍeya Purāṇa)
...
- **Svarocis rescues Manoramā** — grown and trained in brāhmaṇic disciplines, **Svarocis** saves the maiden **Manoramā** (and her companions) from a demon using mantric arrows; he marries her. (Svarocis's adulthood; Mārkaṇḍeya Purāṇa.)
- **The three wives and the secret vidyās** — Svarocis weds Manoramā's two companions as well, each of whom imparts an esoteric knowledge:
  - **Vibhāvarī** (a gandharva maiden) — teaches him mantric powers / the speech of animals.
  - **Kalāvatī** (daughter of a sage by an apsaras) — moved by steadfast *bhakti*, offers herself and bestows the secret **Padminī Vidyā** upon him (adhyāya ~64). (Marriages; Mārkaṇḍeya Purāṇa.)
...
- *Viṣṇu Purāṇa 3.1 (Wilson):* the sons are **Caitra, Kimpuruṣa, and others**.
- *Mārkaṇḍeya Purāṇa:* names **Vijaya, Merunandana and Prabhāsa** as sons of **Svarocis** (one generation up) — easily conflated with the Manu's sons in compilations. [disputed attribution]
...
## Classes of Gods (Deva-gaṇas)

- **Pārāvatas** and **Tuṣitas** — the two deva-classes of this manvantara, named together in the Viṣṇu Purāṇa (3.1) and echoed by the Bhāgavata.
  - The **Tuṣitas** are a recurring deva-gaṇa across early manvantaras; in the Bhāgavata's scheme the avatāra Vibhu is born of a mother named **Tuṣitā**, linking the avatāra to this class.
  - *Note:* spellings **Pāraavat / Pārāvata** appear in popular compilations; same class.

---

## Avatāra of Viṣṇu

The avatāra of the 2nd manvantara is one of the **less stable** entries — the two main Purāṇas give different names:

- *Bhāgavata Purāṇa 8.1:* **Vibhu** — born to the sage **Vedaśiras** and his wife **Tuṣitā**; a lifelong *brahmacārin* who never married and instructed **88,000 ascetics** (*dṛḍha-vratas*) in self-control and austerity. [primary — Bhāgavata]
- *Viṣṇu Purāṇa 3.1 (Wilson):* in Wilson's running text the divine **Yajña**, born as **Ajita** alongside the **Tuṣita** gods, is associated here — though many editions place Yajña-as-Ajita in the **1st (Svāyambhuva)** manvantara, so this is a known cross-attribution between Manvantaras 1 and 2. Compare [Manvantara 1 — Svāyambhuva](./manvantara-01-svayambhuva.md). [disputed — likely belongs to Manvantara 1]
- *Net:* treat **Vibhu** (Bhāgavata) as the standard avatāra of Svārociṣa; flag the **Yajña/Ajita** name as bleed-over from the adjacent manvantara.

---

## The Saptarṣi (Seven Sages) — variant lists

The sage-roster is the chief point of disagreement for this manvantara. The lists below are all attested but cannot be reconciled into a single seven.

- *List A — Viṣṇu Purāṇa 3.1 (Wilson tr.):* **Ūrja, Stambha, Prāṇa, Dattoli (Dattātreya), Ṛṣabha, Niścara, and Arvarīvat** (last name varies in transmission, e.g. **Cārvarīvat / Cārvarīvan**).
- *List B — Hindi/Gita-Press style Viṣṇu Purāṇa rendering:* **Ūrja, Stambha, Prāṇa, Vāta, Vṛṣabha, Nitya and Parivān** — a divergent transliteration of essentially List A. [transmission variant]
- *List C — Bhāgavata-aligned compilation:* **Ūrjastambha, Agni, Prāṇa, Dattoli (Danti), Ṛṣabha, Niścara and Cārvarīvān**. [secondary]
- *List D — popular/HinduPad compilation:* **Dattātreya, Atri, Cyavana, Stambha, Prāṇa, Kaśyapa, Bṛhaspati** — a much later, differently composed list mixing famous ṛṣis from other ages. [secondary compilation — least reliable]
- *Stable cores across lists:* **Ūrja/Ūrjastambha, Stambha, Prāṇa, Ṛṣabha, Niścara**, plus a **Dattoli/Dattātreya** figure; the seventh name is where the lists splinter most.
...
- Viṣṇu Purāṇa 3.1 (Wilson tr.) — Manus and Manvantaras: https://www.wisdomlib.org/hinduism/book/vishnu-purana-wilson/d/doc115978.html
- Viṣṇu Purāṇa, "Description of Manvantaras" (blog rendering of Gita-Press style list): https://vishnu-purana.blogspot.com/2012/10/description-of-manvantaras.html
- Bhāgavata Purāṇa, Canto 8, Ch. 1 (Manvantaras; Indra Rocana; avatāra Vibhu; sons Dyumat/Suṣeṇa/Rociṣmat)
- Mārkaṇḍeya Purāṇa — Pravara & Varūthinī, and the birth of Svarocis / Svārociṣa Manu (Kāmakoṭi/Sage Kanchi rendering): https://www.kamakoti.org/kamakoti/details/markandeyapurana28.html
- Mārkaṇḍeya Purāṇa — Varuthini & Pravara (Dharmawiki): https://dharmawiki.org/index.php/Varuthini_and_Pravara_(%E0%A4%B5%E0%A4%B0%E0%A5%82%E0%A4%A5%E0%A4%BF%E0%A4%A8%E0%A5%80_%E0%A4%AA%E0%A5%8D%E0%A4%B0%E0%A4%B5%E0%A4%B0%E0%A4%B6%E0%A5%8D%E0%A4%9A)
- Story of Varudhini and Pravarakhya (HinduPad): https://hindupad.com/story-of-varudhini-and-pravarakhya/
- Swarochisha Manvantara — second manvantara (HinduPad): https://hindupad.com/swarochisha-manvantara-second-manvantara/
- Manvantaras (Dharmawiki): https://dharmawiki.org/index.php/Manvantaras
- Manu (Hinduism) — Wikipedia (manvantara summary tables): https://en.wikipedia.org/wiki/Manu_(Hinduism)
- Svarocisha Manu — The Second Manvantara: https://www.aroydendsouza.com/post/svarocisha-manu
