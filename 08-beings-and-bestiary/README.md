# Beings & Bestiary — Index

> Section root: `08-beings-and-bestiary/` — the **classes of beings that populate the cosmos between the gods and humans**: the semi-divine attendants, nature-spirits, serpent-folk, demon-races, ghosts, and named composite creatures of the Purāṇas and epics. Up-link: repo [`../README.md`](../README.md).
> Where [`02-deities-and-cosmic-hierarchy/`](../02-deities-and-cosmic-hierarchy/) catalogs the **gods** and [`03-lineages-vamsha/`](../03-lineages-vamsha/) the **human dynasties**, this section catalogs **everyone in between** — the *upadevas* (demigods), the *bestiary* (mythic animals/composites), and the lower spirit-classes. Per repo policy, **all variant rosters, counts, and parentages are cataloged to source**.

---

## The vertical hierarchy at a glance

Hindu cosmology sorts conscious beings into a rough ladder of *guṇa* (purity/power) and *adhikāra* (cosmic station). From the top of the middle world downward, the conventional order is:

**Devas** (gods, upper [lokas](../02-deities-and-cosmic-hierarchy/devas-asuras-and-the-lokas.md)) **> Gandharvas / Apsaras / Kinnaras / Vidyādharas / Cāraṇas** (celestial musicians, dancers, sky-going adepts of Svarga) **> Yakṣas / Guhyakas / Siddhas** (Kubera's nature-spirits & perfected beings) **> Nāgas** (serpent-folk of [Pātāla](../02-deities-and-cosmic-hierarchy/devas-asuras-and-the-lokas.md)) **> Humans** (Bhūloka) **> Rākṣasas / Asuras (Daityas, Dānavas)** (titan-demons of Rasātala) **> Piśācas / Bhūtas / Pretas / Vetālas** (flesh-eaters, ghosts, hungry dead, corpse-spirits). (Source: Wikipedia, *List of legendary creatures in Hindu mythology*; Bhāgavata Purāṇa 5 loka-scheme — see [devas-asuras-and-the-lokas.md](../02-deities-and-cosmic-hierarchy/devas-asuras-and-the-lokas.md))

The ladder is **moral-fluid, not absolute**: a rākṣasa (Vibhīṣaṇa), an asura (Prahlāda, Bali), or a nāga can be righteous, while a deva can fall. The same parentage often produces opposed classes — **Kaśyapa + Aditi → Ādityas (devas); Kaśyapa + Diti → Daityas; Kaśyapa + Danu → Dānavas; Kaśyapa + Kadrū → Nāgas; Kaśyapa + Vinatā → Garuḍa & Aruṇa** — making the whole bestiary one vast half-sibling feud. (Source: Mahābhārata, Ādi Parva; Bhāgavata Purāṇa 6.6)

### The canonical "demigod" frame — the Upadevas

Several Purāṇic lists gather the in-between classes under **Upadevas** ("lesser gods / demigods"), a set commonly enumerated as **ten**: **Vidyādharas, Apsaras, Yakṣas, Rākṣasas, Gandharvas, Kinnaras, Piśācas, Guhyakas, Siddhas, and Bhūtas**. (Source: Wikipedia, *List of legendary creatures in Hindu mythology* — Upadeva classification)
- *Variant (count/membership):* the roster is **open-ended** — other lists add Cāraṇas, Vidyādharīs, Pretas, Nāgas, Daityas, Dānavas, or fold the demonic classes out as separate; no single Purāṇa is authoritative across all. [disputed] (Source: Wikipedia, *List of legendary creatures in Hindu mythology*)
...
- Wikipedia, "Category:Legendary creatures in Hindu mythology" — https://en.wikipedia.org/wiki/Category:Legendary_creatures_in_Hindu_mythology
- Wisdomlib, "Yaksha, Yakṣa: 48 definitions" — https://www.wisdomlib.org/definition/yaksha
