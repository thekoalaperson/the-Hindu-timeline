...
> Where this sits: the cross-cutting **doctrinal layer** — the ideas that underlie every event in the
> timeline but belong to no single age. Back to the [master index](../README.md).

These are the conceptual coordinates of Hindu thought, complementing the chronological spine and the
[literature corpus](../90-literature-corpus/README.md) (which catalogs the *texts* that expound them).

## Contents
- [Puruṣārthas & Karma–Saṃsāra–Mokṣa](purusharthas-and-karma-samsara-moksha.md) — the four aims of life (dharma, artha, kāma, mokṣa) and the rebirth/liberation framework.
- [Ātman, Brahman & the Six Darśanas](atman-brahman-and-the-six-darshanas.md) — self, ultimate reality, the mahāvākyas, and the six orthodox philosophical schools.
- [Varṇa, Āśrama & the Saṃskāras](varna-ashrama-and-samskaras.md) — the social/stage order and the life-cycle rites.
- [Yoga — Paths & Patañjali](yoga-paths-and-patanjali.md) — the yogas (karma/bhakti/jñāna/rāja) and the eight limbs (see also [Yoga Sūtras](../04-deep-dives/yoga-sutras-of-patanjali.md)).
