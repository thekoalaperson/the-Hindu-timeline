...
- **Indra of this Manvantara** — the king of the gods for the Tāmasa cycle, who won the post by performing a hundred *yajñas* (the standard "śatakratu" qualification for Indra-hood).
  ...
  - *Variant (folk/secondary):* occasionally conflated with **Śibi/Śivi**, the famously charitable king, though this appears to be a later confusion rather than a Puranic reading. [disputed] [folk]
- **Classes of Devas (deva-ganas)** — four groups, each numbering 27 deities (108 gods total ruling the age).
  - *Variant (Bhagavata Purana 8.1):* **Satyas, Haris, Vīras** and others; the Manu's contemporaries.
  - *Variant (Vishnu Purana III.1):* **Satyakas, Haris, Vīras** and others as the deva-classes.
  - *Variant (Markandeya / Vedic People):* the four named ganas are **Satyagaṇa, Sudhīgaṇa, Sarpagaṇa (or Surūpagaṇa), Harigaṇa**, each of 27 — total 108. [Variant]
  - *(So the well-attested four are some combination of* ***Satyas/Satyakas, Sudhīs, Haris, Vīras/Sarpas/Surūpas****; the Hari-gaṇa appears in nearly every list, fitting the "Hari" avatar of this cycle.)* [disputed]

## The Saptarishis (Seven Sages)

The seven sages of the Tāmasa cycle, led by **Jyotirdhāma**. The rosters differ only at the tail of the list:

- **Variant (Vishnu Purana III.1):** Jyotirdhāma, Pṛthu, Kāvya, Caitra, Agni, **Vanaka**, Pīvara.
- **Variant (Markandeya / Vedic People):** Jyotirdhāma, Pṛthu, Kavya, Caitra, Agni, **Balāka**, Pivara.
- **Variant (alternate Puranic list):** Kavi, Pṛthu, Agni, Akapi, Kapi, Janya, Dhāma — a markedly divergent form. [disputed]
- *(Jyotirdhāma, Pṛthu, Kāvya/Kavi, Caitra, Agni, Pīvara are stable across recensions; only the sixth name — Vanaka vs. Balāka — shifts. The "Pṛthu" here is a sage, distinct from both the Manu's son and from King Pṛthu.)*
...
- **Gajendra-mokṣa (the liberation of Gajendra)** — the elephant-king Gajendra, seized by the leg by a crocodile (*grāha*) in a forest lake and pulled toward death over a thousand celestial years, finally surrenders all self-effort and calls out to the Supreme; Vishnu mounts Garuda, arrives, severs the crocodile with his Sudarśana cakra, and lifts the elephant from the water — the paradigm story of *prapatti* (total surrender) and unmerited divine grace. (Placed in the Tāmasa Manvantara by the Bhagavata tradition.) (Bhagavata Purana 8.2–8.4.) Full narration: [→ Gajendra-mokṣa deep-dive](../04-deep-dives/gajendra-moksha.md).
  ...
  - **Identity variants within the story:**
    - *Variant (Bhagavata Purana):* the elephant is the **reborn King Indradyumna**, a Pāṇḍya/Drāviḍa devotee cursed by sage Agastya to elephant-birth for a lapse of courtesy; the crocodile is the gandharva **Hūhū**, cursed by the sage Devala for seizing his leg in the water — both freed by the rescue.
    - *Variant (alternate naming):* the deliverer of the age is named simply **Hari** (Harimedha–Hariṇī's son); his identity with the Gajendra-rescuer is the link binding the avatar to this Manvantara.
...
- Vishnu Purana, Book III, Chapter 1 — the several Manus and Manvantaras (Tāmasa: Manu, sons Pṛthu/Khyāti/Nara/Ketu, Indra Triśikha, deva-classes Satyakas/Haris/Vīras, Saptarishis led by Jyotirdhāma). [Sacred-Texts](https://sacred-texts.com/hin/vp/vp075.htm) · [Wisdomlib](https://www.wisdomlib.org/hinduism/book/vishnu-purana-wilson/d/doc115978.html)
- Bhagavata Purana, Skandha 8 (8.1–8.4) — the first four Manvantaras; Indra Śikhi; the avatar Hari (son of Harimedha and Hariṇī); the Gajendra-mokṣa. [Vedabase SB 8.3](https://vedabase.io/en/library/sb/8/3/)
- Markandeya Purana — Tāmasa account: four ganas (Satya, Sudhī, Sarpa, Hari), Saptarishis incl. Balāka.
- Matsya Purana, Adhyaya 9 — account of the Manvantaras (Manus, Saptarishis, deva-ganas). [Vedapath](https://vedapath.app/en/matsya-purana/account-of-the-manvantaras-manus-saptarsis-deva-ganas-and)
- [Tāmasa Manvantara — Vedic People](https://vedicpeople.com/manvantaras/tamasa-manvantara/) (name etymology, four ganas, sons list).
- [Tamasa Manvantara, Fourth Manvantara — HinduPad](https://hindupad.com/tamas-manvantara-fourth-manvantara/)
- [Manvantara — Vyasa Mahabharata / VyasaOnline](https://www.vyasaonline.com/encyclopedia/manvantara/)
- [Manu (Hinduism) — Wikipedia](https://en.wikipedia.org/wiki/Manu_(Hinduism))
- [Gajendra Moksha — Wikipedia](https://en.wikipedia.org/wiki/Gajendra_Moksha) · [Gajendra Moksha (full story) — JKYog](https://jkyog.in/en/wisdom/blog/full-story-gajendra-moksha)
- [Story of Manvantara — Puranic Encyclopaedia (Wisdomlib)](https://www.wisdomlib.org/hinduism/compilation/puranic-encyclopaedia/d/doc241753.html)
