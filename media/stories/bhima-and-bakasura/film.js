  ...
  SETS.forest(ctx, cam, t, {
    ...
    actors: (c) => {
      ...
      drawFigure(c, {
        ...
        pose: {
          lean: 0.05, headTurn: 0.36, headNod: 0.16 + chew * 0.12,
          armF: { sh: lerp(0.82, 1.12, toMouth), el: lerp(1.5, 1.86, toMouth), wr: 0.5, hand: 'hold' },
          armB: { sh: 0.22, el: 0.5, hand: 'relaxed' },
          legF: { hip: 0.12, knee: 0.08 }, legB: { hip: -0.15, knee: 0.12 },
          face: { smile: 0.2, lipsPart: 0.25 + chew * 0.4, eyeOpen: 0.72, lowered: 0.2 },
        },
        t, seed: 21,
      });
      // the morsel held at his open mouth — sells the eating
      const mx = bhX + 44 * bhS, my = bhY - 352 * bhS;
      c.fillStyle = '#e8b84c';
