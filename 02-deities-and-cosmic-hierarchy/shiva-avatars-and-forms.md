...
## Doctrine: how Śiva "descends"

- **Avatāra is secondary to Śiva's theology.** As the *para-tattva* (supreme reality) of Śaivism, Śiva primarily **emanates forms** rather than being born; his "avatars" are mostly assumed-at-will manifestations (*rūpa*) to accomplish a task, then reabsorbed. The full descent-into-a-womb model (as with Vishnu) applies to only a few cases (Hanuman, Grihapati). (*Śiva Purāṇa*, Śatarudra Saṃhitā)
- **Taxonomy of manifestation:**
  - *Avatāra* (19/28) — task-specific incarnations, mostly fierce (*ugra*) or ascetic.
  - *Mūrti* — cosmic "embodiments": the **Aṣṭamūrti** (8 elemental forms) and the **Pañcabrahma / 5 faces**.
  - *Rudra-gaṇa* — the **11 Rudras** of the Vedic 33-deva pantheon, later fused with Śiva.
  - *Anugraha/aspect-mūrti* — iconographic synthesis forms (Ardhanārīśvara, Naṭarāja, etc.), classified in Āgamas as *saumya* (benign) or *raudra/saṃhāra* (fierce).
- **Roster is open-ended** [flag]: no single text fixes the count. The 19-list is the *Śiva Purāṇa*'s; the *Liṅga* and *Kūrma Purāṇas* give 28 *yugācārya* descents (Śiva as teacher in each Dvāpara); the Āgamas enumerate 25 *Maheśvara-mūrti*. Catalog all below.

---

## A. The 19 Avatars (*Śiva Purāṇa*, Śatarudra Saṃhitā)

The canonical fierce/ascetic descent-list. Order varies by edition; identity is the stable element.
...
- **Kṛṣṇa-darśana (Krishna Darshan)** - Sage-form born in the line of King **Nabhaga**, who reasserts the supremacy of *yajña* and ritual (*karma-kāṇḍa*) and Vedic dharma. (*Śiva Purāṇa*)
- **Avadhūta** - Naked wandering-renunciate form who humbles the pride of **Indra** (who blocked his path) by paralyzing the king of gods, teaching ego-dissolution. (*Śiva Purāṇa*)
- **Bhikṣuvarya (Bhikshuvarya / Bhikṣātana-aspect)** - The supreme-mendicant form who, as a protecting beggar, shields a king and embodies the *bhikṣu* ideal; overlaps iconographically with **Bhikṣāṭana** (see aspects below). (*Śiva Purāṇa*)
...
> - *Variant (Śiva Purāṇa):* the standard **19**, as above.
> - *Variant (Liṅga Purāṇa & Kūrma Purāṇa):* **28 Yogeśvara avatars** — Śiva as the founding *yoga-ācārya* in each of the 28 Dvāpara Yugas (Śveta, Sutāra, Madana, Suhotra, Kaṅkaṇa, Lokākṣi, Jaigīṣavya, Dadhivāhana, Ṛṣabha, Bhṛgu, Ugra, Atri, Bali, Gautama, Vedaśiras, Gokarṇa, Guhāvāsī, Śikhaṇḍī, Jaṭāmālī, Aṭṭahāsa, Dāruka, Lāṅgalī, Mahākāla, Śūlī, Daṇḍī, Sahiṣṇu, Somaśarman, Lakulīśa) — the last, **Lakulīśa**, is the historical founder of the [Pāśupata sampradāya](../07-acharyas-and-sampradayas/README.md). [late text]
> - *Variant (folk Tamil/regional):* local *sthala-purāṇa* avatars (e.g. Tirumūlar) added per temple. [folk]

---

## B. Aṣṭamūrti — the 8 cosmic forms (elemental embodiments)

Śiva pervades the cosmos through eight bodies; each is a named *mūrti* governing one element/principle. The classic source is Kālidāsa's invocation in *Abhijñānaśākuntalam* (Act I). (*Vāyu Purāṇa*; *Kūrma Purāṇa*; *Kaushītaki Brāhmaṇa*)

- **Śarva** - the **Earth** (*pṛthivī*) — the supporting, sustaining body.
- **Bhava** - the **Water** (*ap/jala*) — the nourishing, flowing body.
- **Rudra** - the **Fire** (*agni*) — the burning, destructive body; in some lists, the **Moon** (*soma*).
- **Ugra** - the **Wind** (*vāyu*) — the moving body; or, plants/medicines (*oṣadhi*).
- **Bhīma** - the **Ether / Space** (*ākāśa*) — the all-pervading body.
- **Paśupati** - the **Yajamāna / sacrificer (the soul, *kṣetrajña*)** — the form embodied in every living being.
- **Mahādeva (Īśāna)** - the **Sun** (*sūrya*) — the illuminating eye of the day.
- **Aśani (Ugradeva)** - the **Moon** (*candra/soma*) — the cooling eye of the night.

> *Variant element-assignments (Kaushītaki Brāhmaṇa):* Bhava=Water, Śarva=Fire, Paśupati=Air, Ugra=plants/medicines, Mahādeva=Sun, Rudra=Moon, Īśāna=Food, Aśani=Indra/lightning — i.e. the *names map to different elements* across texts. [disputed — assignment varies by source]
> *Variant (8th form as Sun+Moon "two luminaries"):* some lists pair Sūrya and Candra and substitute the *yajamāna*; the standard octad = earth, water, fire, air, ether, sun, moon, sacrificer.

---

## C. The 11 Rudras (Ekādaśa-Rudra)
...
> Note overlap: several Rudra-names (Bhava, Śiva, Kāla, Vāmadeva, Īśāna) recur in the Aṣṭamūrti and the 5 faces — the rosters are interpenetrating layers of one Rudra-theology, not disjoint sets.

---

## D. Pañcānana / Pañcabrahma — the 5 Faces

Śiva's five faces govern the **five cosmic acts** (*pañcakṛtya*): creation, preservation, destruction, concealment (*tirodhāna*), and grace (*anugraha*). Each maps to a direction, element, sense, and a *Brahma*-mantra; together they are the *Sadyojātādi-pañca-brahma* of the [Śaiva Āgamas](../07-acharyas-and-sampradayas/README.md). (*Liṅga Purāṇa*; *Vāyu Purāṇa*; *Maitrāyaṇīya / Pañcabrahma Upaniṣad*)

- **Sadyojāta** - **West**; element **Earth** (*pṛthivī*); act of **creation** (*sṛṣṭi*); benign, child-like. Mantra: *Sadyojātaṃ prapadyāmi…*
- **Vāmadeva** - **North**; element **Water** (*ap*); act of **preservation** (*sthiti*); healing/protecting, often shown as the "left/beautiful" feminine-tending face. Mantra: *Vāmadevāya namo…*
- **Aghora** - **South**; element **Fire** (*agni*); act of **destruction/reabsorption** (*saṃhāra*); fierce yet "non-terrible," the regenerative consuming face (root of the Aghorī tradition). Mantra: *Aghorebhyo'tha ghorebhyo…*
- **Tatpuruṣa** - **East**; element **Air/Wind** (*vāyu*); act of **concealing grace** (*tirodhāna*); the *jīva*/soul-face, embodying *ānanda-śakti*. Mantra: *Tatpuruṣāya vidmahe…*
- **Īśāna** - **Upward / Zenith** (*ūrdhva*); element **Ether/Space** (*ākāśa*); act of **revealing grace** (*anugraha*); the supreme, formless, transcendent face presiding over the other four. Mantra: *Īśānaḥ sarvavidyānām…*
  - *Note:* the four cardinal faces + the unseen upward Īśāna = the five-faced **Pañcamukha Liṅga / Sadāśiva** icon. A sixth, hidden "downward" face (**Adhomukha**, dissolution) appears in some Āgamic lists, yielding a six-faced *Ṣaḍānana* schema. [Āgamic variant]

---

## E. Great Aspect-Forms (Maheśvara-mūrti / iconographic synthesis)

The Śaiva Āgamas enumerate **25 (or 64) Maheśvara-mūrti**, sorted into *saumya* (benign) and *raudra/saṃhāra* (fierce). The principal ones:
...
- **Dakṣiṇāmūrti** - Śiva as the silent **supreme Guru** (*Ādi-Guru*), seated facing south under a banyan, teaching the four primordial Kumāras by *cin-mudrā* (silence); patron of jñāna, yoga, music, and śāstra. Has a dedicated node: [dakshinamurti.md](dakshinamurti.md). (*Śaiva Āgamas*; Śaṅkara's *Dakṣiṇāmūrti Stotra*)
...
### Fierce / destroyer (raudra · saṃhāra-mūrti)
- **Bhairava (Mahākāla / Kālabhairava)** - see Avatar list above; the supreme fierce *kṣetrapāla*.
...
## F. Quick cross-reference map

| Layer | Count | Principle | See |
|---|---|---|---|
| Avatars (descent) | 19 / 28 | task-specific incarnations | this file §A |
| Aṣṭamūrti | 8 | elemental cosmic bodies | §B |
| Rudras | 11 | Vedic 33-deva Rudra-gaṇa | §C |
...
- *Śiva Purāṇa* (Śatarudra Saṃhitā — the 19 avatars; Vidyeśvara & Rudra Saṃhitās — Liṅgodbhava, Tripurāntaka, Kāmāntaka).
- *Liṅga Purāṇa*, *Kūrma Purāṇa*, *Vāyu Purāṇa* (28 Yogeśvara avatars; Aṣṭamūrti; Pañcabrahma).
...
- India Foundation, ["Iconography of Shiva"](https://chintan.indiafoundation.in/articles/iconography-of-shiva/) and Britannica, ["Shiva"](https://www.britannica.com/topic/Shiva) — Maheśvara/aspect-mūrti and Liṅga worship.

> [flag] The avatar/mūrti roster is **open-ended**: the 19/28 avatar counts, the variant 11-Rudra name-lists, the Aṣṭamūrti element-assignments, and the 25/64 Maheśvara-mūrti all differ by text and sampradāya. All major variants are cataloged above with their attributions.
